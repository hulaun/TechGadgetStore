...
export default function VerifyCode() {
    ...
    function handleContinuePress() {
        ...
        router.push("/(auth)/reset-password/UpdatePassword");
    }

    useEffect(() => {
        setDisabled(otp.length < OTP_LENGTH);
    }, [otp]);
            ...
            <View className="justify-center px-8">
                ...
                <View className="w-full mb-6 mt-8">
                    <View className="flex-row justify-between">
                        ...
                        <Text className="mb-4" style={{color: theme.colors.primary}}>Resend Code</Text>
                    </View>
                    <OtpInput
                ...
                >
                    <Text className="text-center font-semibold" style={{color: theme.colors.background}}>Continue</Text>
                </TouchableOpacity>
